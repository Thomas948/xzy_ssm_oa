      ...
      <div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-4 text-left">
				<a class="btn btn-success" href="${pageContext.request.contextPath}/classes/toAdd">添加班级</a>
			</div>
			...
			<div class="col-lg-4 text-center">
				<a class="btn btn-info" href="${pageContext.request.contextPath}/classes/download">导出Excel</a>
			</div>
		</div>
      </div>
...
<script type="text/javascript">
	...
	function getData(pageNum, pageSize, hasPre, hasNext) {
		...
		$.getJSON("${pageContext.request.contextPath}/classes/getPage", {"pageNum": pageNum, "pageSize": pageSize}, function (d) {
			pageNum = d.pageNum;
			pageSize = d.pageSize;
			pages = d.pages;
			hasPre = d.hasPre;
			...
			for (let i = 0; i < list.length; i++) {
				content += "<tr>\n" +
						"<th>"+list[i].classId+"</th>\n" +
						"<td>"+list[i].className+"</td>\n" +
						"<td>"+list[i].subject.subjectName+"</td>\n" +
						"<td>"+list[i].classCount+"</td>\n" +
						"<td>"+list[i].classLife+"</td>\n" +
						"<td>"+list[i].classAddress+"</td>\n" +
						"<td>"+list[i].createTime+"</td>\n" +
						"<td class='text-right'><a onclick=\"return confirm('是否删除');\" class='btn btn-w-xs btn-round btn-danger' href='${pageContext.request.contextPath}/classes/delete/"+list[i].classId+"'>删除</a></td>\n" +
						"<td class='text-left'><a class='btn btn-w-xs btn-round btn-warning' href='${pageContext.request.contextPath}/classes/toUpdate/"+list[i].classId+"'>更新</a></td>\n" +
						"</tr>";
			}
			$("#tbody").html(content);
